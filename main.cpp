...
int main()
{
    ...
    float boxVerticesWithTexCoords[] = {
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(boxVerticesWithTexCoords), boxVerticesWithTexCoords, GL_STATIC_DRAW);
    ...
    unsigned char *data = stbi_load("leaves.jpg", &width, &height, &nrChannels, 0);
    if(data)
    {
